...
public class Utility
{
    ...
    // Anagram
    public void isAnagram() throws IOException
    {
...
//bubblesort of string
    ...
    public String StringbinarySearch(String []arr, String s1)	
    {
        int start=0;
        ...
        {
            int mid = (start+end)/2;
            if(s1.equals(arr[mid]))
                return arr[mid];
            else if(s1.compareTo(arr[mid])>0)
                start = mid+1;
            else 
                end = mid-1;
        }
